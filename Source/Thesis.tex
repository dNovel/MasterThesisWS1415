...
\section{Fazit}
Das Gebiet des Tool Development selbst bleibt ein wichtiger Bestandteil der Produktionsteams. Verschiedene analysierte Interviews und Dokumentationen zeichnen eine positive Entwicklung des Team Developments auch in kleineren Teams ab. Trotz aller heute vorhandenen Techniken die das Entwickeln von Software erleichtern ist das Tool Development immer noch ein kritischer Prozess im Produktionszyklus. Vor allem weil Tools meist während der Produktion eines Spiels / Software weiterentwickelt oder gar neu entwickelt werden müssen.
