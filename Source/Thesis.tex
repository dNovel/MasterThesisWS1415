...
\section{Ziele der Konzeption und der Implementierung}
Das Ziel der Konzeption ist die Umsetzung eines Entwicklungsprozesses und das Erstellen eines Konzeptes für ein auf der Akademischen Simulations und Entertainment Software Fusee basierendes Authoring Tool. Die während dieser Arbeit konzipierte Software hat das Ziel eine Basis für die Verwendung von Cinema 4D als Game Engine Editor aufzubauen. Es werden grundlegende Funktionen in Form einer \CSS Bibliothek entwickelt die es ermöglichen sollen das Projekt in Zukunft auch für andere 3D Modeling Software anzupassen. Diese Arbeit zielt nicht darauf ab ein komplettes Tool für die Entwicklung von Spielen in der Fusee Engine zu erschaffen. Es wird versucht einen Grundstein für weitere Forschung und Entwicklung in den Bereich des Game Authoring Toolkit Developments für die Arbeit mit der Fusee Engine zu legen. Das Kernziel ist die Analyse des Tool Entwicklungsprozesses, das Erstellen eines Konzeptes für das Fusee Authoring Tool und die Erläuterung der einzelnen Module eines solchen Systems. Verschiedene bereits bestehende Tools und Game Engines werden zu Vergleichen herangezogen und wurden im Laufe dieser Arbeit untersucht und analysiert.
...
\subsection{Die Use Cases für Artists}
...
\subsection{Die Use Cases für Designer}
%TODO oder mit Artist zusammen führen.

\subsection{Die Use-Cases eines Engineer}
