...
\begin{figure}[ht]
	...
	\caption{Der Cinema 4D Szenengraph. Verschiedenste Objekte als “Nodes”, darunter exemplarisch Tags verschiedener Tag-Datentypen am rechten Rand der Grafik.}
	\label{Cinema4dSzenenGraph}
\end{figure}

Diese Objekte können wieder Kindobjekten der gleichen Datentypen beeinhalten. Diese Hierarchie zeigt die Abbildung \ref{Cinema4dSzenenGraph}. Die in der Abbildung \ref{Cinema4dSzenenGraph} am rechten Rand durch kleine Abbildungen neben den Nodes dargestellten Tags, beinhalten weitere Daten oder Einstellungen für das jeweils zugehörige Node. Diese können in einem anderen Fenster (Attribute Fenster/Panel) in Cinema 4d bearbeitet werden.
