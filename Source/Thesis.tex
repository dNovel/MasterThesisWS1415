...
%	Hauptteil START
%%%%%%
\chapter{Vergleich und Implementierung des Systems}
\section{Aktuelle Systeme und Möglichkeiten}

\section{Warum eine Trennung von Code und Content?}
\subsection{Die Verschränkung von Szenengraphen}

\section{Das System in Game Engines}
\subsection{Unreal Engine 4}
\subsection{Unity 3D}
\subsection{Cryengine}

\section{Das System in Frameworks}
...
\subsection{Die Übertragung eines Szenengraphen aus Cinema 4D nach FUSEE}
