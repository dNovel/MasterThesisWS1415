...
Diese Arbeit legt sich für den Aspekt des Software-Designs und der Organisatorischen Planung auf die Variante “Dedicated Tools Team” fest. \autocite{Wihlidal2006} beschreibt dieses Organisatorische Projekt wie folgt:
\begin{quote}
...
Um eine Produktion erfolgreich zu starken, bedarf es wie weiter oben angeführt einer Asset Pipeline und den darin enthaltenen Tools. Um zu ergründen, welche Tools für das Projekt nötig sind, sollten sich Lead-Developer zu Beginn des Projekts folgende von \cite{Chandler2006} beschriebene Fragen stellen.
\begin{itemize}
...
\\
\\
Carey Chico\footnote{Aktuell Präsident bei Zero Mass Enery \url{https://www.linkedin.com/in/careychico}, ehemals Pandemic Studios} beschreibt die Wichtigkeit der Asset Pipeline und vor allem des dedizierten internen Tool Developments wie folgt:
\begin{quote}
...
\end{quote}
Hiermit zeigt Chico klar das Kernthema dieser Arbeit auf: Ein Tool, welches auf dem Team bereits bekannter Software basiert, in seiner Bedienung leicht zu verstehen und jedem Mitglied des Teams zur Verfügung steht. Solche Authoring Tools könnten den Produktionsprozess zugänglicher gestalten. Da eine erweiterung des Tools durch die Entwickler dauerhaft möglich wäre, kann auch ein langfristiger Einsatz gewährleistet werden.
